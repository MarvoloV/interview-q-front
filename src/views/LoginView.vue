...
import RocketIcon from '@/components/icons/iconRocket.vue'
import HandsIcon from '@/components/icons/iconHand.vue'
import CulqiLogo from '@/components/icons/culqiLogo.vue'
</script>

<template>
    <main class="relative grid min-h-screen place-items-center bg-dark-500">
        <div class="hidden sm:block">
            <RocketIcon />
            <HandsIcon />
        </div>
        <div class="absolute">
            <div class="flex h-screen w-screen flex-col p-4 sm:h-auto sm:w-[28rem] sm:bg-white sm:p-10 rounded-md">
                <div class="mb-16 flex justify-center sm:mb-6">
                    <CulqiLogo />
                </div>
                <h1 class="mb-10 hidden text-center text-3xl sm:mb-6 sm:block">
                    <span>¡Bienvenido al Culqi</span>
                </h1>
                <div>
                    <form class="w-full">
                        <div class="mb-6">
                            <div class="flex flex-col text-light-100" inputmode="email">
                                ...
                                <div class="relative block">
                                    <input inputmode="email"
                                        class="text-light-100 py-3 px-4 rounded w-full border font-normal h-12 text-xs bg-light-200 placeholder:text-light-500 hover:border-light-400 focus:border-primary-300 border-light-200"
                                        type="email" placeholder="ejemplo@culqi.com" />
                                </div>
                            </div>
                        </div>
                        <div class="mb-6">
                            <div class="flex flex-col">
                                <label class="mb-1 text-micro font-medium text-plate-400">
                                    Contraseña
                                </label>
                                <div class="relative block">
                                    <input enterkeyhint="enter" type="password" placeholder="••••••••••"
                                        class="py-3 px-4 rounded w-full border font-normal h-12 text-xs bg-light-200 placeholder:text-light-500 text-plate-400 border-light-200 hover:border-light-400 focus:border-primary-300" />
                                    <div class="absolute right-4 top-2/4 -translate-y-1/2 text-primary-300">
                        ...
                        <div class="mb-6">
                            <button type="submit"
                                class="box-border inline-flex min-w-min items-center justify-center rounded border-[1px] font-normal leading-tight no-underline transition-colors duration-200 ease-in-out bg-primary-300 text-white border-primary-300 hover:bg-primary-400 hover:border-primary-400 focus:border-primary-200 active:bg-primary-400 active:border-primary-200 disabled:bg-light-300 disabled:border-light-300  text-xl px-[20px] py-[15px] gap-nano w-full">
                                Iniciar sesión
                            </button>
                        </div>
                    </form>
