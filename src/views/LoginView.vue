...
<template>
  <main class="relative grid min-h-screen place-items-center bg-dark-500">
    ...
    <div class="absolute">
      <div
        class="flex h-screen w-screen flex-col p-4 sm:h-auto sm:w-[28rem] sm:bg-white sm:p-10 rounded-md"
      >
            ...
            <div class="mb-6">
              <div class="flex flex-col text-light-100" inputmode="email">
                ...
                <div class="relative block">
                  <input
                    inputmode="email"
                    class="text-light-100 py-3 px-4 rounded w-full border font-normal h-12 text-xl bg-light-200 placeholder:text-light-500 hover:border-light-400 focus:border-primary-300 border-light-200"
                    type="email"
